...
<html lang="en">
  <head>
    ...
    <style>
      :root {
        --primary: #026126ff;         /* Indigo */
        --primary-light: #706903ff;
        --primary-dark: #02471dff;
      ...
      * {
      ...
      body {
        ...
        background-image: url('MainImg/tbcbg.png');
      ...
      .nav {
        ...
        align-items: center;
        padding: 1rem 2rem;
        background-color: rgba(1, 75, 7, 0.8);
  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        <div class="logo">
          <img src="\Services\img\tbc.png" alt="BLUESYS Logo" Style = "height:105px; width:100px">
          <h1>Tele-Back Check</h1>
        </div>
        ...
        <form method="post" action="TBC.php">
    ...
    <div class="footer">
      © <?= date('Y') ?> Tele-Back Check. All rights reserved.
    </div>
  </body>
</html>