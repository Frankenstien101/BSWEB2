...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            ...
            <div class="logo-text">PQR Incentive</div>
        </div>
            ...
            <div class="filter-controls">
                ...
                <select class="form-select SEL sel-site" id="SELECT_SITE" style="width: 150px;" 
                    ...
                    if (!empty($selected_comp)) {
                        $query = "SELECT SITEID, SITE_CODE FROM [dbo].[Aquila_Sites]  s join [dbo].[Aquila_PQR_Users_Branch_Mapping] b on s.SITEID=b.ID WHERE COMPANY_ID = '$selected_comp' $condition";
                        foreach ($conn->query($query) as $row) {
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#sel_comp").change(function() {
                ...
                if (companyId) {
                    $.post('query/select_comp.php', { comp: companyId }, function(data) {
            ...
            $("#SELECT_SITE").change(function() {
                ...
                if (siteId) {
                    $.post('query/select_site.php', { site: siteId }, function(data) {
