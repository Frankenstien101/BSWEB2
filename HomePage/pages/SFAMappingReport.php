...
function loaditems() {
    ...
    fetch(`/HomePage/datafetcher/reports/getdatareports.php?action=loadsfamapping&company=${encodeURIComponent(companyId)}`)
        .then(response => {
...
function exportToExcel() {
    ...
    link.setAttribute("download", "ProductSFAMapping.csv");
