...
<body>
<h3>IN-TRANSIT SUMMARY REPORT</h3>
...
function loaditems() {
    ...
    fetch(`/HomePage/datafetcher/reports/getdatareports.php?action=intransitsummary&company=${encodeURIComponent(companyId)}&siteid=${encodeURIComponent(siteid)}&datefrom=${encodeURIComponent(dateFrom)}&dateto=${encodeURIComponent(dateTo)}`)
        .then(response => {
