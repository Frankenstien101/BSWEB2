...
function loaditems() {
    ...
    fetch(`/HomePage/datafetcher/reports/getdatareports.php?action=sellers&company=${encodeURIComponent(companyId)}`)
        .then(response => {
        ...
        .then(data => {
            ...
            data.forEach((item, index) => {
                ...
                tr.innerHTML = `
                    ...
                    <td>${item.SELLER_SUB_ID || ''}</td>
                    <td>${item.SELLER_NAME || ''}</td>
                    <td>${item.SELLER_TYPE || ''}</td>
                    <td>${item.SELLER_LOGIN || ''}</td>
                    <td>${item.SELLER_PASSWORD || ''}</td>
                    <td class="${statusClass}">${item.STATUS || ''}</td>
                    <td>${item.CATEGORY || ''}</td>
                    <td>${item.SB_VAN_ID || ''}</td>
                    <td>${item.DSS || ''}</td>
                    <td>${item.DEFAULT_WH || ''}</td>
