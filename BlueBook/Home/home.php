...
<head>
  ...
  <style>
    ...
    .sidebar-dark-primary {
      background: linear-gradient(135deg, #0e6191ff 0%, #004b91ff 100%) !important;
    }
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link text-center">
      <img src="/Services/img/blubooknew.png" alt="Logo" style="width: 100px; height: 100px;">
      <span class="brand-text font-weight-bold d-block">BLUE BOOK</span>
    </a>
