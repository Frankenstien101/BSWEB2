...
function loaditems() {
    ...
    fetch(`/LM/datafetcher/reportsdata.php?action=devicechecking&company=${encodeURIComponent(companyId)}&datefrom=${encodeURIComponent(dateFrom)}&dateto=${encodeURIComponent(dateTo)}`)
        .then(response => {
...
function exportToExcel() {
    ...
    XLSX.writeFile(workbook, "DeviceCheckingResult.xlsx");
}
