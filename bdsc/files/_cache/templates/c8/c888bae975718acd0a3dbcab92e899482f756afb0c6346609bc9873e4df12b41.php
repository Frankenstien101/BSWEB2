...
class __TwigTemplate_4ab6cb707790915de3513e0515763c7320a71a20d04f2853ed59c841fa90943c extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 58
        if (((0 === CoreExtension::compare(($context["withtemplate"] ?? null), 2)) &&  !CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 58))) {
            // line 59
   ...
   ";
        ...
        } elseif ((0 === CoreExtension::compare(        // line 61
...
($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 63)) {
            ...
            // line 66
            yield "   ";
            if (((0 === CoreExtension::compare(($context["noid"] ?? null), false)) && ($this->extensions['Glpi\Application\View\Extension\SessionExtension']->session("glpiis_ids_visible") || (0 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["nametype"] ?? null)), 0))))) {
                // line 67
                yield "      ";
...
<div id=\"header_";
   ...
   ";
        // line 81
        if (((0 === CoreExtension::compare(($context["withtemplate"] ?? null), 1)) && CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 81))) {
            // line 82
   ...
   ";
      ...
      ";
        ...
        // line 88
        yield "      ";
        if (( !($context["in_navheader"] ?? null) && (1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["icon"] ?? null)), 0)))) {
            // line 89
      ...
      ";
        ...
        // line 97
        yield "         ";
        if (((0 === CoreExtension::compare(($context["withtemplate"] ?? null), 1)) && (1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "id", [], "any", false, false, false, 97), 0)))) {
            // line 98
            yield "            ";
   ...
   ";
      ...
      ";
            ...
            <label class=\"form-check d-flex align-items-center mb-0\">
               ";
                // line 138
                $context["disabled"] = (0 === CoreExtension::compare(($context["canedit"] ?? null), false));
                // line 139
                yield "               ";
...
";
    ...
    {
        return new Source("", "components/form/header_content.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\form\\header_content.html.twig");
    }
}
