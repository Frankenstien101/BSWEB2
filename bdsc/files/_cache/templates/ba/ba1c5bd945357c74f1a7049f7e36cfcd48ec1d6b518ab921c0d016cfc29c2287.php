...
class __TwigTemplate_0db6f64011adf5577d5df957040fb53480337a052e49c6dd6e1f23385db4374a extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 40
        if (((0 === CoreExtension::compare(($context["user_thumbnail"] ?? null), null)) &&  !$this->extensions['Glpi\Application\View\Extension\ConfigExtension']->getEntityConfig("display_users_initials", $this->extensions['Glpi\Application\View\Extension\SessionExtension']->session("glpiactive_entity")))) {
            // line 41
            yield "    ";
...
";
    ...
    {
        return new Source("", "components/user/picture.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\user\\picture.html.twig");
    }
}
