...
class __TwigTemplate_6c2449d0eb29ee3834f465eeb1fe601cefb0bccbcbe3c3fc9914b0589ba94d6b extends Template
{
    private $source;
    private $macros = [];
        ...
        $context["toasts_html"] = ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if (Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["messages"] ?? null))) {
                ...
                foreach ($context['_seq'] as $context["type"] => $context["message"]) {
                    ...
                    // line 42
                    yield "            ";
                    if ((0 === CoreExtension::compare($context["type"], Twig\Extension\CoreExtension::constant("ERROR")))) {
                        // line 43
                        yield "                ";
                        ...
                        // line 45
                        yield "            ";
                    } elseif ((0 === CoreExtension::compare($context["type"], Twig\Extension\CoreExtension::constant("WARNING")))) {
                        // line 46
                        yield "                ";
...
";
    ...
    {
        return new Source("", "components/messages_after_redirect_toasts.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\messages_after_redirect_toasts.html.twig");
    }
}
