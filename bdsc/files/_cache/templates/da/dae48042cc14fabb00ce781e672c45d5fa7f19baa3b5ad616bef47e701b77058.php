...
class __TwigTemplate_b5922f01cd4f2d5aa2725e9628100f760216b01c57f96abe0eba0628eb593935 extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   ";
            ...
            // line 67
            yield "   ";
            if ((CoreExtension::getAttribute($this->env, $this->source, ($context["_request"] ?? null), "_in_modal", [], "array", true, true, false, 67) && (0 === CoreExtension::compare((($__internal_compile_16 = ($context["_request"] ?? null)) && is_array($__internal_compile_16) || $__internal_compile_16 instanceof ArrayAccess ? ($__internal_compile_16["_in_modal"] ?? null) : null), "1")))) {
                // line 68
   ...
   ";
      ...
      ";
        // line 81
        yield "      ";
        if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 81), "request", ["in_modal"], "method", false, false, false, 81), true))) {
            // line 82
    ...
    {
        return new Source("", "components/form/header.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\form\\header.html.twig");
    }
}
