...
class __TwigTemplate_854a7dd69e2c0b11375308ae1e78c44051c8cb7a08b5ca1308ec2eee9714eff0 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 53
        if ((0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->getCurrentInterface(), "helpdesk"))) {
            // line 54
            yield "    ";
...
";
        ...
        // line 59
        if ((0 !== CoreExtension::compare(($context["current_entity"] ?? null), ($context["current_entity_short"] ?? null)))) {
            // line 60
            yield "    ";
...
";
        ...
        <div class=\"dropdown-menu p-3\">
            ...
            // line 78
            yield "                ";
            if ((0 === CoreExtension::compare(($context["platform"] ?? null), Twig\Extension\CoreExtension::constant("donatj\\UserAgent\\Platforms::MACINTOSH")))) {
                // line 79
                yield "                    ";
...
";
    ...
    {
        return new Source("", "layout/parts/profile_selector.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\layout\\parts\\profile_selector.html.twig");
    }
}
