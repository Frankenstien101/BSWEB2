...
class __TwigTemplate_da97fc07db0f23390f281b471de27602f0fa7267b4b3e7f07b4ef4b3f1fcb7b0 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 34
        $context["is_vertical"] = (0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("page_layout"), "vertical"));
        // line 35
        $context["is_horizontal"] = (0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("page_layout"), "horizontal"));
        // line 36
        $context["is_menu_folded"] = (0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("fold_menu"), "1"));
        // line 37
...
";
      ...
      <div class=\"dropdown-menu ";
                // line 61
                yield (((($context["firstlevel_active"] ?? null) && (0 !== CoreExtension::compare(($context["is_vertical"] ?? null), false)))) ? ("") : ("animate__animated"));
                yield " ";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["sublevel"]) {
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, $context["sublevel"], "page", [], "array", true, true, false, 74)) {
                        // line 75
                        yield "               <a class=\"dropdown-item ";
                        yield (((0 === CoreExtension::compare(($context["menu_active"] ?? null), (($__internal_compile_14 = $context["sublevel"]) && is_array($__internal_compile_14) || $__internal_compile_14 instanceof ArrayAccess ? ($__internal_compile_14["title"] ?? null) : null)))) ? ("active") : (""));
                        yield "\"
                  href=\"";
                        // line 76
               ...
               ";
                    ...
                    // line 86
                    yield "               ";
                    if (((0 === CoreExtension::compare((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 86) % ($context["count_per_column"] ?? null)), ((($context["has_dashboard"] ?? null)) ? ((($context["count_per_column"] ?? null) - 1)) : (0)))) &&  !CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 86))) {
                        // line 87
                        yield "                  </div>
                  <div class=\"dropdown-menu-column\">
               ";
...
$context["firstlevel"], "default", [], "array", true, true, false, 95) && (0 !== CoreExtension::compare((((CoreExtension::getAttribute($this->env, $this->source, $context["firstlevel"], "display", [], "array", true, true, false, 95) &&  !(null === (($__internal_compile_24 = $context["firstlevel"]) && is_array($__internal_compile_24) || $__internal_compile_24 instanceof ArrayAccess ? ($__internal_compile_24["display"] ?? null) : null)))) ? ((($__internal_compile_25 = $context["firstlevel"]) && is_array($__internal_compile_25) || $__internal_compile_25 instanceof ArrayAccess ? ($__internal_compile_25["display"] ?? null) : null)) : (true)), false)))) {
                // line 96
                yield "      <li class=\"nav-item dropdown ";
                yield ((($context["firstlevel_active"] ?? null)) ? ("active") : (""));
...
";
    ...
    {
        return new Source("", "layout/parts/menu.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\layout\\parts\\menu.html.twig");
    }
}
