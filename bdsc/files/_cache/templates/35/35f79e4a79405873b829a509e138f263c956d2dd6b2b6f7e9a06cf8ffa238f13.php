...
class __TwigTemplate_3f9047952dcdf7a2d54b21378ac5a30443c0d8d424fd96e1a61601a5852335ae extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 36
        if ((-1 === CoreExtension::compare(($context["total_number"] ?? null), 1))) {
            // line 37
   ...
   <table class=\"table table-hover\">
      <thead>
         <tr>
            ...
            // line 54
            yield (((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["filters"] ?? null)), 0))) ? ("btn-secondary active") : ("btn-outline-secondary"));
            yield "\">
         ...
         ";
            // line 66
            if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["filters"] ?? null)), 0))) {
                // line 67
...
($context["filters"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["date"] ?? null) : null), "", ["no_label" => true, "full_width" => true, "mb" => ""]], 73, $context, $this->getSourceContext());
      ...
      ";
            // line 116
            if ((-1 === CoreExtension::compare(($context["filtered_number"] ?? null), 1))) {
                // line 117
...
";
    ...
    {
        return new Source("", "components/logs.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\logs.html.twig");
    }
}
