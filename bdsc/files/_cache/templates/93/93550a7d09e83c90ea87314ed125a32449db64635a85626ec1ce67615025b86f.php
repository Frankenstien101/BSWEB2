...
class __TwigTemplate_33a59e7ce9b34d140a85a0292feb11189e505cc7f8dcade006a75796561d1ec6 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((($context["canedit"] ?? null) || CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "canEdit", [(($__internal_compile_8 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 43)) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8["id"] ?? null) : null)], "method", false, false, false, 43))) {
         ...
         ";
            // line 45
            if (((1 === CoreExtension::compare(($context["withtemplate"] ?? null), 0)) || CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewID", [($context["id"] ?? null)], "method", false, false, false, 45))) {
                // line 46
                yield "            ";
                if (((0 >= CoreExtension::compare(($context["id"] ?? null), 0)) || (0 === CoreExtension::compare(($context["withtemplate"] ?? null), 2)))) {
                    // line 47
         ...
         ";
            // line 136
            if ((($context["canedit"] ?? null) && (1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), (($__internal_compile_10 = ($context["params"] ?? null)) && is_array($__internal_compile_10) || $__internal_compile_10 instanceof ArrayAccess ? ($__internal_compile_10["addbuttons"] ?? null) : null)), 0)))) {
                // line 137
                yield "            ";
    ...
    {
        return new Source("", "components/form/buttons.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\form\\buttons.html.twig");
    }
}
