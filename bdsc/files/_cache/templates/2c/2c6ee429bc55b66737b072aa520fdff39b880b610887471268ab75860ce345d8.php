...
class __TwigTemplate_91d2e63efc0952541ae0d9da4885fcc58d7af46ebb4c73a4e3d301d2acf4197e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_alert($__alert_type__ = "", $__title__ = "", $__messages__ = [], $__icon__ = "", $__important__ = false, ...$__varargs__)
    {
      ...
      <div class=\"d-flex\">
         ...
         <div>
            ...
            // line 46
            yield "            ";
            if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["messages"] ?? null)), 0))) {
                // line 47
...
";
    ...
    {
        return new Source("", "components/alerts_macros.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\alerts_macros.html.twig");
    }
}
