...
class __TwigTemplate_29bb0efe2377908cc9e13ae6e8c4195e847f3b8c88f0ff3d8ec62e126f4a171f extends Template
{
    private $source;
    private $macros = [];
...
<body class=\"";
   ...
   ";
        // line 39
        if ((Twig\Extension\CoreExtension::constantIsDefined("SKIP_UPDATES") && (0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Update::isDbUpToDate"), false)))) {
            // line 40
   ...
   <div class=\"page\">
      ...
      <header class=\"navbar d-print-none sticky-lg-top shadow-sm ";
        // line 93
        yield (((0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("page_layout"), "vertical"))) ? ("navbar-light navbar-expand-md") : ("navbar-dark navbar-expand-xl topbar"));
        yield "\">
         <div class=\"container-fluid flex-xl-nowrap pe-xl-0\">
            ";
        // line 95
        if ((0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("page_layout"), "vertical"))) {
            // line 96
            yield "               ";
            ...
            ";
        } elseif ((0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("page_layout"), "horizontal"))) {
            // line 103
      ...
      ";
        // line 130
        if ((0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("page_layout"), "horizontal"))) {
            // line 131
...
";
    ...
    {
        return new Source("", "layout/parts/page_header.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\layout\\parts\\page_header.html.twig");
    }
}
