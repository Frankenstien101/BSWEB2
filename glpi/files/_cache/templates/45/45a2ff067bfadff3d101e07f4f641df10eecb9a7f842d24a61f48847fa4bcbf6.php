...
class __TwigTemplate_94539f3cbca81126e6de683308f66c4bee8f49118c8f9923eff8486357d88aff extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 34
        if ((Session::haveRight("inventory", Twig\Extension\CoreExtension::constant("READ")) && (0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isDynamic", [], "method", false, false, false, 34), false)))) {
            // line 35
...
";
    ...
    {
        return new Source("", "components/form/inventory_info.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\form\\inventory_info.html.twig");
    }
}
