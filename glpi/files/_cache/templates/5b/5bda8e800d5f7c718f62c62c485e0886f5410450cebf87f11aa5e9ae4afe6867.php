...
class __TwigTemplate_44cb180f2ef149170eb4194612f5070b0f4028c13bfa0c20b1bc272f4cca9287 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ( !array_key_exists("additional_params", $context)) {
            ...
            // line 37
            yield "    ";
            if (((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["additional_params"] ?? null)), 0)) &&  !(is_string($__internal_compile_0 = ($context["additional_params"] ?? null)) && is_string($__internal_compile_1 = "&") && str_starts_with($__internal_compile_0, $__internal_compile_1)))) {
                // line 38
                yield "        ";
...
";
        ...
        // line 44
        if ((array_key_exists("is_tab", $context) && (0 === CoreExtension::compare(($context["is_tab"] ?? null), true)))) {
            // line 45
            yield "   ";
...
";
        ...
        // line 55
        if ((1 === CoreExtension::compare(($context["current_end"] ?? null), ($context["count"] ?? null)))) {
            // line 56
            yield "    ";
...
";
        ...
        // line 60
        if ((0 >= CoreExtension::compare((($context["current_start"] ?? null) - ($context["list_limit"] ?? null)), 0))) {
            // line 61
            yield "   ";
            $context["back"] = 0;
        }
...
($context["href"] ?? null), ["%start%" => ($context["start"] ?? null)])]);
    ...
    <ul class=\"pagination m-0 mt-sm-2 mt-md-0\">
        ";
        // line 91
        if ((1 === CoreExtension::compare(($context["nb_pages"] ?? null), 1))) {
            // line 92
            yield "            ";
            $context["is_first_page"] = (0 === CoreExtension::compare(($context["start"] ?? null), 0));
            // line 93
            yield "            ";
            $context["is_last_page"] = (0 <= CoreExtension::compare(($context["forward"] ?? null), ($context["count"] ?? null)));
            // line 94
            yield "
            <li class=\"page-item ";
            // line 95
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                // line 106
                yield "                ";
                if (((0 >= CoreExtension::compare((($context["current_page"] ?? null) - ($context["adjacents"] ?? null)), $context["page"])) && (0 <= CoreExtension::compare((($context["current_page"] ?? null) + ($context["adjacents"] ?? null)), $context["page"])))) {
                    // line 107
                    yield "                    ";
                    $context["page_start"] = (($context["page"] - 1) * ($context["limit"] ?? null));
                    // line 108
                    yield "                    <li class=\"d-none d-sm-block page-item ";
                    if ((0 === CoreExtension::compare($context["page"], ($context["current_page"] ?? null)))) {
                    ...
                    ";
                    // line 111
                    if ((0 === CoreExtension::compare((($context["current_page"] ?? null) + ($context["adjacents"] ?? null)), $context["page"]))) {
                        // line 112
                        yield "                    ";
                        $context["skip_adjacents"] = false;
                        // line 113
                    ...
                    // line 114
                    yield "                ";
                } elseif ((0 === CoreExtension::compare(($context["skip_adjacents"] ?? null), false))) {
                    // line 115
                    yield "                    ";
...
";
    ...
    {
        return new Source("", "components/pager.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\pager.html.twig");
    }
}
