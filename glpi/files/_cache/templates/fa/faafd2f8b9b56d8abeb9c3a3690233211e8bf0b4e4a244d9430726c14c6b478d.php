...
class __TwigTemplate_0001dbc085c87f736343b105baeefdfc0f8a107a3aeb51ff40e03e0a728f5dc0 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 52
        if (((array_key_exists("withtemplate", $context) && (1 === CoreExtension::compare(($context["withtemplate"] ?? null), 0))) && (1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), (($__internal_compile_4 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 52)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4["template_name"] ?? null) : null)), 0)))) {
            // line 53
            yield "<div class=\"row\">
   <div class=\"col-12\">
      ";
...
";
    ...
    {
        return new Source("", "components/form/dates.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\form\\dates.html.twig");
    }
}
