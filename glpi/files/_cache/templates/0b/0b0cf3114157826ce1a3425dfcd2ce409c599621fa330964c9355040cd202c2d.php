...
class __TwigTemplate_63b32c77c0bb55a6a99a0b0d6f54b28c4a40e818fd28eedc77c7bbf3952f2a6f extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 38
        if ((((0 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["host"] ?? null)), 0)) || (0 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["user"] ?? null)), 0))) || CoreExtension::getAttribute($this->env, $this->source, ($context["link"] ?? null), "connect_error", [], "any", false, false, false, 38))) {
            // line 39
            yield "
   ";
            // line 40
         ...
         <form action='install.php' method='post'>
            <div class=\"mb-3\">
               <h3>
                  ";
                // line 79
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((((0 === CoreExtension::compare(($context["update"] ?? null), "no"))) ? (__("Please select a database:")) : (__("Please select a database to update:"))), "html", null, true);
                yield "
               </h3>
               <div class=\"form-selectgroup form-selectgroup-boxes d-flex flex-column\">
                  ";
                // line 82
                if ((0 === CoreExtension::compare(($context["update"] ?? null), "no"))) {
                    // line 83
...
{% else %}
   ...
   {% endif %}
{% endif %}
", "install/step3.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\install\\step3.html.twig");
    }
}
