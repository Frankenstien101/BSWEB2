...
class __TwigTemplate_60436900dcc069d2892e133a3f23ffe7b8d8552b729b5bbdd0ca75199f78a234 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["type"] => $context["link"]) {
            // line 72
            yield "   ";
            if ((((0 === CoreExtension::compare($context["type"], "add")) || (0 === CoreExtension::compare($context["type"], "search"))) || (0 === CoreExtension::compare($context["type"], "lists")))) {
                // line 73
                yield "   ";
            } elseif ((0 === CoreExtension::compare($context["type"], "template"))) {
                // line 74
                yield "      <li class=\"nav-item\">
         <a href=\"";
                // line 75
   ...
   ";
            } elseif ((0 === CoreExtension::compare(            // line 80
$context["type"], "showall"))) {
   ...
   ";
            } elseif ((0 === CoreExtension::compare(            // line 87
$context["type"], "summary"))) {
   ...
   ";
            } elseif ((0 === CoreExtension::compare(            // line 94
$context["type"], "summary_kanban"))) {
   ...
   ";
            } elseif ((0 === CoreExtension::compare(            // line 101
$context["type"], "transfer_list"))) {
   ...
   ";
            } elseif ((0 === CoreExtension::compare(            // line 108
$context["type"], "config"))) {
                // line 109
                yield "      <li class=\"nav-item\">
         <a href=\"";
...
";
    ...
    {
        return new Source("", "layout/parts/context_links.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\layout\\parts\\context_links.html.twig");
    }
}
