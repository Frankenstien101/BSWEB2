...
class __TwigTemplate_6097e4356886092523fb5e06af9d73a534f8cd8faab63daf17faf2fba4f6461e extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"d-inline-flex search-controls\">
   ";
        // line 35
        if ((($context["showmassiveactions"] ?? null) && (1 === CoreExtension::compare(($context["count"] ?? null), 0)))) {
            // line 36
            yield "      ";
   ...
   <div class=\"d-inline-flex\" role=\"group\">
      ...
      ";
        // line 90
        if ((($context["can_config"] ?? null) && (1 === CoreExtension::compare(($context["count"] ?? null), 0)))) {
            // line 91
...
($context["posthref"] ?? null));
         ...
         ";
            // line 143
            if ((0 !== CoreExtension::compare(($context["itemtype"] ?? null), "Stat"))) {
                // line 144
...
";
    ...
    {
        return new Source("", "components/search/controls.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\search\\controls.html.twig");
    }
}
