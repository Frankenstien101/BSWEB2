...
class __TwigTemplate_9f9b49105ca6fb3d771cae055900a5db5eb71ec2d796a13e1a0a86687068eddc extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 71
        if ((1 === CoreExtension::compare(($context["max"] ?? null), 10))) {
            // line 72
            yield "   ";
   ...
   ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["value"]) {
            ...
            yield "\" ";
            yield (((0 === CoreExtension::compare($context["value"], $this->extensions['Glpi\Application\View\Extension\SessionExtension']->userPref("list_limit")))) ? ("selected") : (""));
            yield ">
         ";
            // line 81
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["value"], "html", null, true);
...
";
    ...
    {
        return new Source("", "components/dropdown/limit.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\components\\dropdown\\limit.html.twig");
    }
}
