...
class __TwigTemplate_292933089d96046d1da887e6722079e1ba70381ab0ac97d442ce478d239f5f65 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content_block($context, array $blocks = [])
    {
      ...
      <div class=\"row justify-content-center\">
        ...
        yield "
            ...
            ";
        // line 95
        if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["errors"] ?? null)), 0))) {
            // line 96
            yield "               <hr />
        ...
        if (($context["right_panel"] ?? null)) {
            ...
            yield "            <div class=\"col-auto px-2 text-center\">
               ";
            // line 105
            if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["text_login"] ?? null)), 0))) {
                // line 106
...
";
    ...
    {
        return new Source("", "pages/login.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\pages\\login.html.twig");
    }
}
