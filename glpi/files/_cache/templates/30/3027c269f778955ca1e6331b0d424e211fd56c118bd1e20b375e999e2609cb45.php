...
class __TwigTemplate_7c1f61dff94f89fb11ff871d84a94cda1b4981118336d79b66f501c9239e634d extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 34
        if (((0 === CoreExtension::compare($this->extensions['Glpi\Application\View\Extension\SessionExtension']->getCurrentInterface(), "central")) && $this->extensions['Glpi\Application\View\Extension\ConfigExtension']->config("allow_search_global"))) {
            // line 35
            yield "<form action=\"";
...
";
    ...
    {
        return new Source("", "layout/parts/global_search_form.html.twig", "C:\\Users\\Administrator\\Documents\\BSPI_SERVER\\DEPLOYMENT\\glpi\\templates\\layout\\parts\\global_search_form.html.twig");
    }
}
