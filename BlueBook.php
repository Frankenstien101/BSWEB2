    ...
    try {
        ...
        if ($user) {
            if ($user['PASSWORD'] === $password) {
                ...
                header("Location: BlueBook/Home/home.php");
                exit();
            } else {
...
<html lang="en">
  <head>
    ...
    <title>Login | BLUE BOOK</title>
    <style>
      :root {
        --navy-blue: #0A1931;
        --navy-blue-light: #13274F;
        --navy-blue-dark: #07121F;
        --deep-orange: #1915eeff;
        --deep-orange-light: #7d91a8ff;
        --deep-orange-dark: #0819b1ff;
        --text: #f8fafc;
        --text-light: #e2e8f0;
        --text-muted: #94a3b8;
        --bg-dark: #0f172a;
      ...
      * {
      ...
      body {
        ...
        background-image: url('MainImg/fin1.jpg');
      ...
      input:focus {
        ...
        box-shadow: 0 0 0 2px rgba(6, 48, 236, 0.25);
      }
      ...
      .nav {
        ...
        position: relative;
        z-index: 1;
        border-bottom: 1px solid rgba(52, 115, 231, 0.2);
      }
  ...
  <body>
    ...
    <div class="container">
      <div class="card">
        <div class="logo">
          <img src="Services/img/blubooknew.png" alt="DELIVERY DASH Logo">
          <h1>BLUE BOOK</h1>
        </div>
        ...
        <form method="post" action="BlueBook.php">
    ...
    <div class="footer">
      © <?= date('Y') ?> Blue Book. All rights reserved.
    </div>
  </body>
</html>